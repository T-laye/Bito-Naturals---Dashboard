...
navsContainer.addEventListener("click", function(e) {
    ...
    //Active content Area
    document.querySelector(`.content--${clicked.dataset.tab}`).classList.add("display--section");
});
/////////////////////////////////
////Themes
...
const products = [
    {
        name: "Coconut Oil",
        image: 'https://images.everydayhealth.com/images/creative-ways-to-use-coconut-oil-1440x810.jpg?sfvrsn=ad85993_1" alt="coconut',
    ...
    },
    {
        ...
        image: "https://post.healthline.com/wp-content/uploads/2020/07/533274-The-Best-Micellar-Shampoos-for-Clean-Shiny-Hair-732x549-Feature-732x549.jpg",
        description: "Keep your hair dandruff free with our shampoo",
        price: "2000"
    },
    {
        name: "Deep conditioner",
        image: "https://cdn.shopify.com/s/files/1/0660/1153/products/main02_grande.png?v=1478069565",
        description: "Healthy hair conditioner",
        price: "1500"
    },
    {
        name: "Lice treatment",
        image: "https://www.suave.com/sk-eu/content/dam/brands/suave/united_states_ofamerica/60448107-58552949.png.rendition.767.767.png",
    ...
    {
        name: "Comb set",
        image: "https://www-konga-com-res.cloudinary.com/w_auto,f_auto,fl_lossy,dpr_auto,q_auto/media/catalog/product/V/N/153414_1650541308.jpg",
        description: "Effective break-no-more combs",
        price: "1500"
    },
    {
        name: "Protein Treatment",
        image: "https://www.mirrorsbeautylounge.com/mirror-admin/public/images/sub-service-gallery/Layer%2014.jpg",
        description: "Healthy hair growth remedy",
        price: "2000"
    },
    {
        name: "Hair growth Kit",
        image: "https://kdbdeals.com/wp-content/uploads/2022/02/Bombay-Shaving-Company-Hair-Growth-Kit-with-Dermaroller.jpg",
        description: "Complete hair growth set",
        price: "10000"
    },
    {
        name: "Hair cream",
        image: "https://static1.michael84.co.uk/wp-content/uploads/mens-hair-style-tips-advice-1080x670.jpg",
        description: "Healthy haircream mixture",
        price: "500"
    },
    {
        name: "Natural hair relaxer",
        image: "https://hips.hearstapps.com/vader-prod.s3.amazonaws.com/1595269934-mizani-1595269916.jpg?crop=1xw:1xh;center,top&resize=480:*",
...
function updateTotal() {
    ...
    // console.log(delBtns);
    // console.log(rows);
    orderBtns.forEach((orderBtn, i)=>orderBtn.addEventListener("click", function() {
            rows.forEach((row, r)=>{
                if (r === i) {
                    console.log("jane", i);
                    orderContainer.classList.add("hidden-form");
                    const qtyOrdered = document.querySelector(".qtyOrdered");
                    const qtyProd = Array.from(document.getElementsByClassName("qty-input"));
                    const productOrdered = document.querySelector(".productOrdered");
                    const productTitle = Array.from(document.getElementsByClassName("productTitle"));
                    const orderTotal = document.querySelector(".orderTotal");
                    const prodTotal = Array.from(document.getElementsByClassName("total"));
                    // console.log(qtyOrdered, productOrdered, prodTotal, qty);
                    ////
                    qtyProd.forEach((qty, q)=>{
                        if (q === i) qtyOrdered.value = qty.value;
                    });
                    productTitle.forEach((prod, p)=>{
                        if (p === i) productOrdered.value = prod.textContent;
                    });
                    prodTotal.forEach((ord, o)=>{
                        if (o === i) orderTotal.value = ord.textContent;
                    });
                }
            });
    ...
    delBtns.forEach((delBtn, i, arr)=>rows.forEach((row, v)=>{
